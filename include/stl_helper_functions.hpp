...
{
inline constexpr const char *__stl_helper_utility_library_version__{
  "0.2.0-devel"
};
using std::min;
...
public:
  tracer (std::ostream &os, const char *filename, const size_t line_number)
      : output_stream{ os }, m_filename{ filename },
  ...
  std::string
  operator() (const char *format, Args &&...args) const
  {
    const size_t buffer_len{ 1024U };
    char buffer[buffer_len];

    const auto count = snprintf (buffer, buffer_len,
                                 "%s (line no.: %" SIZE_T_PFORMAT ") -> ",
...
constexpr bool
are_data_types_equal (T &&arg1, U &&, Args &&...args)
{
...
template <typename T, typename U, typename... Args>
constexpr bool
check_data_types_for_equality (T &&arg1, U &&arg2, Args &&...args)
{
  if constexpr (0 == sizeof...(Args))
    return std::is_same_v<T, U>;
...
template <typename T, typename U, typename... Args>
constexpr bool
check_if_type_is_identical_to (T &&arg1, U &&arg2, Args &&...args)
{
  if constexpr (0 == sizeof...(Args))
    return std::is_same_v<T, U>;
...
template <typename T, typename = void> struct has_key_type : std::false_type
{
};
...
template <typename T, typename U>
struct has_insert_member_func<T, U,
                              std::void_t<has_insert_member_func_t<T, U>>>
    : std::true_type
{
};
...
template <typename T, typename U>
struct has_find_member_function<T, U,
...
template <typename T>
using has_operator_dereference_t
...
struct is_operator_not_equals_defined<
    T, std::void_t<is_operator_not_equals_defined_t<T>>> : std::true_type
{
};
...
struct is_operator_less_than_defined<
    T, U, std::void_t<is_operator_less_than_defined_t<T, U>>> : std::true_type
{
};
...
template <typename T>
struct has_begin_member_function<T,
                                 std::void_t<has_begin_member_function_t<T>>>
    : std::true_type
{
};
...
template <typename T>
void
show_var_info (const T &arg, std::ostream &os)
{
  os << "\nName: ";
  PRINT_VAR_NAME (arg);
...
template <typename Runnable> class run_at_scope_exit
{
  Runnable callable;
...
#define SetUpTaskToRunAtScopeExit(next_counter_value, ...)                    \
  SetUpRunAtScopeExitObject (                                                 \
      ...
      TOKEN_PASTE (auto_generated_instance_, next_counter_value),             \
      __VA_ARGS__)

#define Auto(...) SetUpTaskToRunAtScopeExit (__COUNTER__, __VA_ARGS__)

template <typename... Runnable> class run_task_at_scope_exit
{
...
auto
create_tasks_to_run_at_scope_exit (Runnable &&...tasks)
{
  return run_task_at_scope_exit<Runnable...>{ std::forward (tasks)... };
}

template <typename T, T start, T last> class crange
{
...
public:
  ...
  template <typename ContainerType> operator ContainerType () const
  {
  ...
  begin () const
  {
    return std::begin (crange_);
  }

  constexpr auto
  end () const
  {
    return std::end (crange_);
  }

  constexpr auto
  cbegin () const
  {
    return std::cbegin (crange_);
  }

  constexpr auto
  cend () const
  {
    return std::cend (crange_);
  }
};

template <typename T, T first, T last>
constexpr auto
begin (const crange<T, first, last> &cr)
{
  return cr.begin ();
}
...
template <typename T, T first, T last>
auto
end (const crange<T, first, last> &cr)
{
  return cr.end ();
}
...
template <typename T, T first, T last>
auto
cbegin (const crange<T, first, last> &cr)
{
  return cr.cbegin ();
}
...
template <typename T, T first, T last>
auto
cend (const crange<T, first, last> &cr)
{
  return cr.cend ();
}
...
public:
  ...
  cbegin () const
  {
    return std::cbegin (range_);
  }

  auto
  cend () const
  {
    return std::cend (range_);
  }
};

template <typename T>
auto
begin (const range<T> &r)
{
  return r.begin ();
}
...
template <typename T>
void
show_var_info_w (const T &arg, std::wostream &wos)
{
  wos << L"\nName: ";
  PRINT_VAR_NAMEW (arg);
...
template <typename CharType> struct default_whitespace_chars
{
};

template <> struct default_whitespace_chars<std::nullptr_t>
{
  static constexpr const char *value = " \t\n\f\v\r";
};

template <> struct default_whitespace_chars<char>
{
  static constexpr const char *value = " \t\n\f\v\r";
};

template <> struct default_whitespace_chars<wchar_t>
{
  static constexpr const wchar_t *value = L" \t\n\f\v\r";
};

template <> struct default_whitespace_chars<char16_t>
{
  static constexpr const char16_t *value = u" \t\n\f\v\r";
};

template <> struct default_whitespace_chars<char32_t>
{
  static constexpr const char32_t *value = U" \t\n\f\v\r";
};

#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
template <> struct default_whitespace_chars<char8_t>
{
...
template <typename T> struct is_non_const_char_pointer_type
{
  static constexpr const bool value
      = is_anyone_of_v<T, char *,
#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
                       char8_t *, char8_t *const,
#endif
                       wchar_t *, char16_t *, char32_t *, char *const,
                       wchar_t *const, char16_t *const, char32_t *const>;
};
...
template <typename T> struct is_const_char_pointer_type
{
  static constexpr const bool value
      = is_anyone_of_v<T, const char *,
#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
                       const char8_t *, const char8_t *const,
#endif
                       const wchar_t *, const char16_t *, const char32_t *,
                       const char *const, const wchar_t *const,
                       const char16_t *const, const char32_t *const>;
};
...
template <typename T> struct is_non_const_char_array_type
{
  static constexpr bool value
      = 1U == std::rank_v<T> && is_valid_char_type_v<std::remove_extent_t<T>>
...
template <typename T> struct is_const_char_array_type
{
  static constexpr bool value
      = 1U == std::rank_v<T> && is_valid_char_type_v<std::remove_extent_t<T>>
        && std::is_const_v<std::remove_extent_t<T>>;
...
template <typename T> struct is_char_pointer_type
{
  static constexpr const bool value
...
template <typename T> struct is_char_array_type
{
  static constexpr const bool value
...
template <typename T> struct remove_all_decorations
{
  using dt = std::decay_t<T>;

  using mt1 = std::conditional_t<std::is_const_v<dt> || std::is_volatile_v<dt>,
                                 std::remove_cv_t<dt>, dt>;
  using mt2 = std::conditional_t<std::is_array_v<mt1>,
                                 std::remove_all_extents_t<mt1>, mt1>;
  using mt3 = std::conditional_t<std::is_pointer_v<mt2>,
                                 std::remove_pointer_t<mt2>, mt2>;
  using mt4 = std::conditional_t<std::is_reference_v<mt3>,
                                 std::remove_reference_t<mt3>, mt3>;
  using type
      = std::conditional_t<std::is_const_v<mt4> || std::is_volatile_v<mt4>,
                           std::remove_cv_t<mt4>, mt4>;
};
...
template <typename T> struct remove_cv_ref
{
  ...
  using mt2 = std::conditional_t<std::is_reference_v<mt1>,
                                 std::remove_reference_t<mt1>, mt1>;
  using type
...
template <typename T> struct is_valid_string_type
{
  static constexpr const bool value
      = is_anyone_of_v<remove_all_decorations_t<T>, std::string, std::wstring,
...
template <typename T> struct is_valid_string_view_type
{
  static constexpr const bool value
      = is_anyone_of_v<remove_all_decorations_t<T>, std::string_view,
                       std::wstring_view, std::u16string_view,
                       std::u32string_view
#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
                       ,
                       std::u8string_view
...
struct get_char_type<
    T, std::void_t<has_value_type_t<remove_all_decorations_t<T>>>>
{
...
template <typename T> using get_char_type_t = typename get_char_type<T>::type;

template <typename T> struct add_const_pointer_to_char_type
{
...
template <typename T, size_t ARRAY_SIZE,
          typename = std::enable_if_t<is_valid_char_type_v<T>>>
constexpr size_t
len (const std::array<T, ARRAY_SIZE> &arr)
{
  size_t length{};
...
template <typename... Args>
size_t
say_slow (std::ostream &os, const size_t time_delay_in_ms,
...
template <typename... Args>
size_t
say_slow (std::wostream &os, const size_t time_delay_in_ms,
          const wchar_t *format_string, Args &&...args)
{
...
template <typename... Args>
size_t
say (std::ostream &os, const char *format_string, Args &&...args)
{
...
template <typename... Args>
size_t
say (std::wostream &os, const wchar_t *format_string, Args &&...args)
{
    ...
    = default_whitespace_chars_v<get_char_type_t<T>>)
{
  ...
  const T first_char_pos{ std::find_if (
      src, src + src_len, [&trimmed_chars] (const auto ch) {
    ...
    = default_whitespace_chars_v<get_char_type_t<T>>)
{
  ...
  // last_char_pos =
  //   std::find_if(std::crbegin(src), std::crend(src), [&trimmed_chars](const
  //   auto ch) {
  //     return trimmed_chars.find(ch) == std::cend(trimmed_chars);
  //   }).base();
...
bool
ltrim_in_place (
    T src, add_const_pointer_to_char_type_t<get_char_type_t<T>> chars_to_trim
           = default_whitespace_chars_v<get_char_type_t<T>>)
{
  using char_type = get_char_type_t<T>;
  ...
  char_type *first_char_pos{ std::find_if (
      first, last, [&trimmed_chars] (const auto ch) {
        return trimmed_chars.find (ch) == std::cend (trimmed_chars);
      }) };
...
std::basic_string<get_char_type_t<T>>
trim (const T src,
      ...
      = default_whitespace_chars_v<get_char_type_t<T>>)
{
  ...
  const auto first{ std::find_if (
      std::cbegin (source_str), std::cend (source_str),
      [&trimmed_chars] (const auto ch) {
        return trimmed_chars.find (ch) == std::cend (trimmed_chars);
      }) };
  ...
  const auto last{ std::find_if (std::crbegin (source_str),
                                 std::crend (source_str),
                                 [&trimmed_chars] (const auto ch) {
                                   return trimmed_chars.find (ch)
                                          == std::cend (trimmed_chars);
                                 })
      ...
      = default_whitespace_chars_v<get_char_type_t<T>>)
{
  ...
  const auto last_iter{ std::find_if (std::crbegin (src), std::crend (src),
                                      [&trimmed_chars] (const auto ch) {
                                        return trimmed_chars.find (ch)
                                               == std::cend (trimmed_chars);
                                      })
...
constexpr bool
starts_with_all_of (const SrcIterType src_first, const SrcIterType src_last,
                    const DstIterType dst_first, const DstIterType dst_last)
{
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr bool
starts_with_any_of (const SrcIterType src_first, const SrcIterType src_last,
                    const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return false;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && (is_char_array_type_v<U> || is_char_pointer_type_v<U>
                  ...
                  || is_valid_string_view_type_v<U> || is_valid_char_type_v<U>)
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
bool
str_starts_with (const T &src, const U &needle, const bool ignore_case = false,
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              typename std::iterator_traits<SrcIterType>::value_type,
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr SrcIterType
find_first_all_of (const SrcIterType src_first, const SrcIterType src_last,
                   const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return src_last;
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr SrcIterType
find_first_any_of (const SrcIterType src_first, const SrcIterType src_last,
                   const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return src_last;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_index_of (const T &src, const U &needle, const size_t start_pos = 0U,
      ...
      if (std::has_facet<std::ctype<char_type>> (loc))
        {
          ...
          std::transform (std::cbegin (src_sv), std::cend (src_sv),
                          std::begin (src_lc),
        ...
        {
          std::transform (std::cbegin (src_sv), std::cend (src_sv),
                          std::begin (src_lc), [] (const auto ch) {
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::vector<size_t>
str_find_all_of (const T &src, const U &needle, const size_t start_pos = 0U,
                 const bool ignore_case = false,
                 const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr SrcIterType
find_last_all_of (SrcIterType src_first, const SrcIterType src_last,
                  const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return src_last;
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr SrcIterType
find_last_any_of (SrcIterType src_first, const SrcIterType src_last,
                  const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return src_last;
 ...
 * @param ForwardIterType last -> an iterator value (of a forward,
 * bidirectional or random access iterator type) which points to the last
 * element of a range of elements
 *
 ...
 * [first, last].
 *
 * @return std::pair<ForwardIterType, ForwardIterType> -> a pair of iterators
 * of type ForwardIterType (forward, bidirectional or random access iterator
 * type) pointing the first found range of consecutive elements which are all
  ...
  if constexpr (stl::helper::has_find_member_function_v<ContainerType, T>)
    {
      const auto found{ std::find_if (
          first, last, [&haystack] (const auto &current_element) {
      ...
      ++second;
      second = std::find_if (
          second, last, [&haystack] (const auto &current_element) {
            return std::cend (haystack) == haystack.find (current_element);
          });
      return { found, second };
    }
 ...
 * @return std::pair<ForwardIterType, ForwardIterType> -> a pair of iterators
 * of type ForwardIterType (forward, bidirectional or random access iterator
 * type) pointing the first found range of consecutive elements which form the
 * longest word of elements that are all contained in the provided @haystack of
 * allowed elements.
 */
template <typename IterType, typename ContainerType>
std::pair<IterType, IterType>
find_longest_word (IterType first, const IterType last,
                   ContainerType &haystack)
{
  ...
  while (first != last)
    {
      const auto [seq_first, seq_last]
          = find_first_sequence_of_allowed_elements (first, last, haystack,
                                                     is_haystack_sorted);
...
str_last_index_of (const T &src, const U &needle,
      ...
      if (std::has_facet<std::ctype<char_type>> (loc))
        {
          ...
          std::transform (std::cbegin (src_lc), std::cend (src_lc),
                          std::begin (src_lc),
                          [&f] (const auto ch) { return f.tolower (ch); });
          needle_lc = f.tolower (needle);
        }
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr bool
contains_all_of (const SrcIterType src_first, const SrcIterType src_last,
                 const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return false;
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr bool
contains_any_of (const SrcIterType src_first, const SrcIterType src_last,
                 const DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return false;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
bool
str_contains (const T &src, const U &needle, size_t start_pos = 0U,
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr bool
ends_with_all_of (const SrcIterType src_first, const SrcIterType src_last,
                  DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return false;

  const typename std::iterator_traits<SrcIterType>::difference_type
      src_seq_len{ std::distance (src_first, src_last) };
  ...
  return target_iter
         == std::search (target_iter, src_last, dst_first, dst_last);
}
...
template <typename SrcIterType, typename DstIterType,
          typename = std::enable_if_t<check_equality_v<
              ...
              typename std::iterator_traits<DstIterType>::value_type>>>
constexpr bool
ends_with_any_of (const SrcIterType src_first, const SrcIterType src_last,
                  DstIterType dst_first, const DstIterType dst_last)
{
  if (src_first == src_last || dst_first == dst_last)
    return false;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
bool
str_ends_with (const T &src, const U &needle, bool ignore_case = false,
               const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
  ...
  if constexpr (is_valid_char_type_v<U>)
  ...
  else
    {
      ...
      if (!ignore_case)
        {
          for (size_t i{ expected_start_pos_of_needle }, j{}; i < src_len;
               i++, j++)
            {
              if (src[i] != needle[j])
                return false;
...
template <typename T, typename... Args> struct is_container_adapter_type
{
...
inline bool
has_key (const ContainerType &container, KeyType &&key)
{
...
inline bool
has_value (const ContainerType &container, const ValueType &value)
{
      ...
      if constexpr (is_operator_less_than_defined_v<
                        typename ContainerType::value_type>)
        {
          if (std::is_sorted (std::cbegin (container), std::cend (container)))
            return std::binary_search (std::cbegin (container),
                                       std::cend (container), value);
        }
...
inline bool
has_value (const std::array<T, N> &container, U &&value)
{
  ...
  return std::cend (container)
         != std::find (std::cbegin (container), std::cend (container),
                       std::forward<U> (value));
}
...
template <typename T, size_t N, typename U,
          ...
          = std::enable_if_t<check_equality_v<T, std::remove_reference_t<U>>>>
inline bool
has_value (const T (&arr)[N], U &&value)
{
  if constexpr (is_operator_less_than_defined_v<T>)
    {
...
template <typename ContainerType,
          typename = std::enable_if_t<has_key_type_v<ContainerType>
                                      ...
                                      && has_mapped_type_v<ContainerType>>>
inline bool
has_kv_pair (const ContainerType &container,
...
inline bool
has_item (const ForwardIterType first, const ForwardIterType last,
          ItemType &&item)
{
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
inline int
str_compare (const T &src1, const U &src2)
{
...
template <typename FwIterType1, typename FwIterType2,
          typename = std::enable_if_t<std::is_same_v<
              get_char_type_t<
                  typename std::iterator_traits<FwIterType1>::value_type>,
              get_char_type_t<
                  typename std::iterator_traits<FwIterType2>::value_type>>>>
inline int
str_compare (FwIterType1 first1, FwIterType1 last1, FwIterType2 first2,
             FwIterType2 last2)
{
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
inline int
str_compare_n (const T &src1, const U &src2,
...
template <typename FwIterType1, typename FwIterType2,
          typename = std::enable_if_t<std::is_same_v<
              ...
              get_char_type_t<
                  typename std::iterator_traits<FwIterType2>::value_type>>>>
inline int
str_compare_n (FwIterType1 first1, FwIterType1 last1, FwIterType2 first2,
               FwIterType2 last2,
               std::common_type_t<
                   typename std::iterator_traits<FwIterType1>::difference_type,
                   typename std::iterator_traits<FwIterType2>::difference_type>
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
inline int
str_compare_i (const T &src1, const U &src2,
               const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename FwIterType1, typename FwIterType2,
          typename = std::enable_if_t<std::is_same_v<
              ...
              get_char_type_t<
                  typename std::iterator_traits<FwIterType2>::value_type>>>>
inline int
str_compare_i (FwIterType1 first1, FwIterType1 last1, FwIterType2 first2,
               FwIterType2 last2, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<
      typename std::iterator_traits<FwIterType1>::value_type>;
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
inline int
str_compare_n_i (const T &src1, const U &src2,
                 size_t number_of_characters_to_compare,
                 const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
inline int
str_compare_n_i (
    FwIterType1 first1, FwIterType1 last1, FwIterType2 first2,
    FwIterType2 last2,
    std::common_type_t<
        typename std::iterator_traits<FwIterType1>::difference_type,
        typename std::iterator_traits<FwIterType2>::difference_type>
...
template <
    typename T, size_t ARRAY_SIZE, typename U,
    typename = std::enable_if_t<
        is_valid_char_type_v<T> && !std::is_const_v<T>
        && (is_char_array_type_v<U> || is_char_pointer_type_v<U>
            || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>)
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_copy (T (&dst)[ARRAY_SIZE], const U &src,
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_copy (T dst, const size_t dst_capacity_in_number_of_characters,
          const U &src,
          str_copy_behavior copy_options
          = str_copy_behavior::disallow_partial_copy,
          size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_copy (T &dst, const U &src, size_t *required_dst_capacity = nullptr)
{
  const auto src_len{ len (src) };
  if (required_dst_capacity)
...
template <typename T, typename U, size_t ARRAY_SIZE,
          typename = std::enable_if_t<
              is_valid_string_type_v<T> && !std::is_const_v<T>
              && is_valid_char_type_v<U>
              && std::is_same_v<get_char_type_t<T>, std::remove_cv_t<U>>>>
size_t
str_copy (T &dst, U (&src)[ARRAY_SIZE],
          size_t *required_dst_capacity = nullptr)
{
  const auto src_len{ len (src) };
  if (required_dst_capacity)
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_copy_n (T (&dst)[ARRAY_SIZE], const U &src,
            ...
            size_t *required_dst_capacity = nullptr)
{
  ...
  std::copy (std::cbegin (src_sv), std::cbegin (src_sv) + no_chars_to_copy,
             dst);
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_copy_n (T dst, size_t dst_capacity_in_number_of_characters, const U &src,
            size_t number_of_characters_to_copy,
            str_copy_behavior copy_options
            = str_copy_behavior::disallow_partial_copy,
            size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U, size_t ARRAY_SIZE,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, std::remove_cv_t<U>>>>
size_t
str_copy_n (T &dst, U (&src)[ARRAY_SIZE],
            size_t number_of_characters_to_copy
            = std::basic_string<get_char_type_t<T>>::npos,
            size_t *required_dst_capacity = nullptr)
{
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_append (T (&dst)[ARRAY_SIZE], const U &src,
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_append (T dst, size_t dst_capacity_in_number_of_characters, const U &src,
            ...
            size_t *required_dst_capacity = nullptr)
{
  ...
  const size_t no_of_chars_to_copy = min_element (
      dst_capacity_in_number_of_characters - dst_len - 1, src_len);
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && (is_valid_string_type_v<U> || is_valid_string_view_type_v<U>
                  || is_char_pointer_type_v<U> || is_char_array_type_v<U>)
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_append (const T &dst, const U &src,
            size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
  const size_t dst_len{ len (dst) };
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_append (T &dst, const U &src, size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
  const size_t dst_len{ len (dst) };
  const size_t src_len{ len (src) };
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_append_n (T (&dst)[ARRAY_SIZE], const U &src,
              ...
              size_t *required_dst_capacity = nullptr)
{
  ...
  dst[dst_len + number_of_characters_to_append]
      = static_cast<char_type> ('\0');
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_append_n (T dst, const size_t dst_capacity_in_number_of_characters,
              const U &src,
              size_t number_of_characters_to_append
              = std::basic_string<get_char_type_t<T>>::npos,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_append_n (const T &dst, const U &src,
              size_t number_of_characters_to_append
              = std::basic_string<get_char_type_t<T>>::npos,
              size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_append_n (T &dst, const U &src,
              size_t number_of_characters_to_append
              = std::basic_string<get_char_type_t<T>>::npos,
              size_t *required_dst_capacity = nullptr)
{
  ...
  if (required_dst_capacity)
    *required_dst_capacity
        = dst.length () + number_of_characters_to_append + 1;
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_prepend (T (&dst)[ARRAY_SIZE], const U &src,
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_prepend (T dst, const size_t dst_capacity_in_number_of_characters,
             const U &src,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_prepend (const T &dst, const U &src,
             size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
void
str_prepend (T &dst, const U &src, size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_prepend_n (T (&dst)[ARRAY_SIZE], const U &src,
               ...
               size_t *required_dst_capacity = nullptr)
{
  ...
  number_of_characters_to_prepend = min_element (
      ARRAY_SIZE - dst_len - 1, number_of_characters_to_prepend);
  ...
  dst[number_of_characters_to_prepend + dst_len]
      = static_cast<char_type> ('\0');
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_prepend_n (T dst, size_t dst_capacity_in_number_of_characters,
               const U &src,
               size_t number_of_characters_to_prepend
               = std::basic_string<get_char_type_t<T>>::npos,
               str_prepend_behaviour prepend_options
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_prepend_n (const T &dst, const U &src,
               size_t number_of_characters_to_prepend
               = std::basic_string<get_char_type_t<T>>::npos,
               size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
void
str_prepend_n (T &dst, const U &src,
               size_t number_of_characters_to_prepend
               = std::basic_string<get_char_type_t<T>>::npos,
               size_t *required_dst_capacity = nullptr)
{
  ...
  if (required_dst_capacity)
    *required_dst_capacity
        = dst.length () + number_of_characters_to_prepend + 1;
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_insert (T (&dst)[ARRAY_SIZE], const size_t position_index_in_dst,
            const U &src,
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_insert (T dst, size_t dst_capacity_in_number_of_characters,
            size_t position_index_in_dst, const U &src,
            ...
            size_t *required_dst_capacity = nullptr)
{
  ...
  const size_t nocti = min_element (
      dst_capacity_in_number_of_characters - 1 - dst_len, src_len);
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_insert (const T &dst, const size_t position_index_in_dst, const U &src,
            size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
void
str_insert (T &dst, const size_t position_index_in_dst, const U &src,
            size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
  const size_t dst_len{ dst.length () };
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_insert_n (T (&dst)[ARRAY_SIZE], const size_t position_index_in_dst,
              const U &src, size_t number_of_characters_to_insert,
              const str_insert_behaviour insert_options
              = str_insert_behaviour::disallow_partial_insert,
              size_t *required_dst_capacity = nullptr)
{
  ...
  const size_t required_dst_size{ dst_len + number_of_characters_to_insert
                                  + 1 };
...
template <
    ...
    typename = std::enable_if_t<
        ...
        && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_insert_n (T dst, const size_t dst_capacity_in_number_of_characters,
              const size_t position_index_in_dst, const U &src,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_insert_n (const T &dst, const size_t position_index_in_dst, const U &src,
              size_t number_of_characters_to_insert,
              size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
void
str_insert_n (T &dst, const size_t position_index_in_dst, const U &src,
              size_t number_of_characters_to_insert,
              size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_char_pointer_type_v<T> || is_char_array_type_v<T>>>
std::basic_string<get_char_type_t<T>>
substr (const T &src, const size_t start_pos,
...
template <typename T, size_t ARRAY_SIZE, typename U, typename V,
          typename = std::enable_if_t<
              is_valid_char_type_v<T> && !std::is_const_v<T>
              ...
              && (is_valid_char_type_v<V> || is_char_array_type_v<V>
                  || is_char_pointer_type_v<V> || is_valid_string_type_v<V>
                  || is_valid_string_view_type_v<V>)
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_first (T (&dst)[ARRAY_SIZE], const U &needle, const V &replace,
                   ...
                   size_t *required_dst_capacity = nullptr)
{
  ...
  const size_t required_dst_buffer_size{ dst_len - needle_len + replace_len
                                         + 1 };
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && (is_valid_char_type_v<V> || is_char_array_type_v<V>
                  || is_char_pointer_type_v<V> || is_valid_string_type_v<V>
                  || is_valid_string_view_type_v<V>)
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_first (T dst, const size_t dst_capacity_in_number_of_characters,
                   const U &needle, const V &replace,
                   const size_t start_position_in_dst = 0U,
                   const bool ignore_case_when_searching_for_needle = false,
                   size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && (is_valid_char_type_v<U> || is_valid_string_type_v<U>
                  || is_valid_string_view_type_v<U>
                  || is_char_pointer_type_v<U> || is_char_array_type_v<U>)
              && (is_valid_char_type_v<V> || is_valid_string_type_v<V>
                  || is_valid_string_view_type_v<V>
                  || is_char_pointer_type_v<V> || is_char_array_type_v<V>)
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
std::basic_string<get_char_type_t<T>>
str_replace_first (const T &dst, const U &needle, const V &replace,
                   const size_t start_position_in_dst = 0U,
                   const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_first (T &dst, const U &needle, const V &replace,
                   const size_t start_position_in_dst = 0U,
                   const bool ignore_case_when_searching_for_needle = false,
                   size_t *required_dst_capacity = nullptr)
{
...
template <typename T, size_t ARRAY_SIZE, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_nth (T (&dst)[ARRAY_SIZE], const U &needle, const V &replace,
                 ...
                 size_t *required_dst_capacity = nullptr)
{
  ...
  do
    {
      const size_t next_pos{ str_index_of (
          dst_sv, needle_sv, nth_needle_pos,
          ignore_case_when_searching_for_needle) };
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_nth (T dst, const size_t dst_capacity_in_number_of_characters,
                 const U &needle, const V &replace,
                 const size_t nth_needle_index = 1,
                 const size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
std::basic_string<get_char_type_t<T>>
str_replace_nth (const T &dst, const U &needle, const V &replace,
                 const size_t nth_needle_index = 1,
                 const size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *count_of_replaced_needles = nullptr,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_nth (T &dst, const U &needle, const V &replace,
                 const size_t nth_needle_index = 1,
                 const size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *required_dst_capacity = nullptr)
...
template <typename T, size_t ARRAY_SIZE, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_last (T (&dst)[ARRAY_SIZE], const U &needle, const V &replace,
                  ...
                  size_t *required_dst_capacity = nullptr)
{
  ...
  const size_t last_needle_pos{ str_last_index_of (
      dst_sv, needle_sv, start_position_in_dst,
      ignore_case_when_searching_for_needle) };
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_last (T dst, const size_t dst_capacity_in_number_of_characters,
                  const U &needle, const V &replace,
                  const size_t start_position_in_dst
                  = std::basic_string<get_char_type_t<T>>::npos,
                  const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
std::basic_string<get_char_type_t<T>>
str_replace_last (const T &dst, const U &needle, const V &replace,
                  const size_t start_position_in_dst
                  = std::basic_string<get_char_type_t<T>>::npos,
                  const bool ignore_case_when_searching_for_needle = false,
                  size_t *count_of_replaced_needles = nullptr,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_last (T &dst, const U &needle, const V &replace,
                  const size_t start_position_in_dst
                  = std::basic_string<get_char_type_t<T>>::npos,
                  const bool ignore_case_when_searching_for_needle = false,
                  size_t *required_dst_capacity = nullptr)
...
template <typename T, size_t ARRAY_SIZE, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_all (T (&dst)[ARRAY_SIZE], const U &needle, const V &replace,
                 ...
                 size_t *required_dst_capacity = nullptr)
{
  ...
  do
    {
      const size_t needle_start_pos{ str_index_of (
          dst_sv, needle_sv, start_position_in_dst,
          ignore_case_when_searching_for_needle) };
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_all (T dst, const size_t dst_capacity_in_number_of_characters,
                 const U &needle, const V &replace,
                 size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
std::basic_string<get_char_type_t<T>>
str_replace_all (const T &dst, const U &needle, const V &replace,
                 size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *count_of_replaced_needles = nullptr,
                 size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_all (T &dst, const U &needle, const V &replace,
                 size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *required_dst_capacity = nullptr)
{
...
template <typename T, size_t ARRAY_SIZE, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_first_n (T (&dst)[ARRAY_SIZE], const U &needle, const V &replace,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_first_n (T dst, const size_t dst_capacity_in_number_of_characters,
                     const U &needle, const V &replace,
                     const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
std::basic_string<get_char_type_t<T>>
str_replace_first_n (const T &dst, const U &needle, const V &replace,
                     const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
                     size_t *count_of_replaced_needles = nullptr,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_first_n (T &dst, const U &needle, const V &replace,
                     const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
                     size_t *required_dst_capacity = nullptr)
...
template <typename T, size_t ARRAY_SIZE, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_last_n (T (&dst)[ARRAY_SIZE], const U &needle, const V &replace,
                    const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<std::remove_cv_t<T>>::npos,
                    const bool ignore_case_when_searching_for_needle = false,
                    size_t *required_dst_capacity = nullptr)
{
  ...
  do
    {
      const size_t needle_start_pos{ str_last_index_of (
          dst_sv, needle_sv, start_position_in_dst,
          ignore_case_when_searching_for_needle) };
      if (std::basic_string_view<char_type>::npos == needle_start_pos)
        break;
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_last_n (T dst, const size_t dst_capacity_in_number_of_characters,
                    const U &needle, const V &replace,
                    const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<get_char_type_t<T>>::npos,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
std::basic_string<get_char_type_t<T>>
str_replace_last_n (const T &dst, const U &needle, const V &replace,
                    const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<get_char_type_t<T>>::npos,
                    const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U, typename V,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                             get_char_type_t<V>>>>
size_t
str_replace_last_n (T &dst, const U &needle, const V &replace,
                    const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<get_char_type_t<T>>::npos,
                    const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, size_t ARRAY_SIZE,
          typename
          = std::enable_if_t<is_valid_char_type_v<T> && !std::is_const_v<T>>>
size_t
str_erase_n_chars (T (&dst)[ARRAY_SIZE], const size_t start_position_in_dst,
                   size_t n, size_t *required_dst_capacity = nullptr)
{
  using char_type = std::remove_cv_t<T>;
...
size_t
str_erase_n_chars (T dst, const size_t start_position_in_dst, size_t n,
                   size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T, size_t ARRAY_SIZE, typename U,
          typename = std::enable_if_t<
              is_valid_char_type_v<T> && !std::is_const_v<T>
              && (is_valid_char_type_v<U> || is_char_array_type_v<U>
                  || is_char_pointer_type_v<U> || is_valid_string_type_v<U>
              ...
              && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_erase_first (T (&dst)[ARRAY_SIZE], const U &needle,
                 const size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_erase_first (T dst, const U &needle,
                 const size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
                 size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_erase_first (const T &dst, const U &needle,
                 const size_t start_position_in_dst = 0U,
                 const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, size_t ARRAY_SIZE, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_erase_nth (T (&dst)[ARRAY_SIZE], const U &needle,
               const size_t nth_needle_index = 1,
               const size_t start_position_in_dst = 0U,
               const bool ignore_case_when_searching_for_needle = false,
               size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_erase_nth (T dst, const U &needle, const size_t nth_needle_index = 1,
               const size_t start_position_in_dst = 0U,
               const bool ignore_case_when_searching_for_needle = false,
               size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_erase_nth (const T &dst, const U &needle,
               const size_t nth_needle_index = 1,
               const size_t start_position_in_dst = 0U,
               const bool ignore_case_when_searching_for_needle = false,
               size_t *count_of_erased_needles = nullptr,
...
template <typename T, size_t ARRAY_SIZE, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_erase_last (T (&dst)[ARRAY_SIZE], const U &needle,
                const size_t start_position_in_dst
                = std::basic_string<std::remove_cv_t<T>>::npos,
                const bool ignore_case_when_searching_for_needle = false,
                size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_erase_last (T dst, const U &needle,
                const size_t start_position_in_dst
                = std::basic_string<get_char_type_t<T>>::npos,
                const bool ignore_case_when_searching_for_needle = false,
                size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_erase_last (const T &dst, const U &needle,
                const size_t start_position_in_dst
                = std::basic_string<get_char_type_t<T>>::npos,
                const bool ignore_case_when_searching_for_needle = false,
                size_t *count_of_erased_needles = nullptr,
...
template <typename T, size_t ARRAY_SIZE, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_erase_all (T (&dst)[ARRAY_SIZE], const U &needle,
               size_t start_position_in_dst = 0U,
               const bool ignore_case_when_searching_for_needle = false,
               size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_erase_all (T dst, const U &needle, size_t start_position_in_dst = 0U,
               const bool ignore_case_when_searching_for_needle = false,
               size_t *required_dst_capacity = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_erase_all (const T &dst, const U &needle,
               size_t start_position_in_dst = 0U,
               const bool ignore_case_when_searching_for_needle = false,
               size_t *count_of_erased_needles = nullptr,
               size_t *required_dst_capacity = nullptr)
...
template <typename T, size_t ARRAY_SIZE, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_replace_first_n (T (&dst)[ARRAY_SIZE], const U &needle,
                     const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
                     size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_replace_first_n (T dst, const U &needle, const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
                     size_t *required_dst_capacity = nullptr)
{
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_replace_first_n (const T &dst, const U &needle,
                     const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
                     size_t *count_of_erased_needles = nullptr,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_replace_first_n (T &dst, const U &needle,
                     const size_t first_n_needle_count,
                     size_t start_position_in_dst = 0U,
                     const bool ignore_case_when_searching_for_needle = false,
                     size_t *required_dst_capacity = nullptr)
...
template <typename T, size_t ARRAY_SIZE, typename U,
          typename = std::enable_if_t<
              ...
              && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
size_t
str_replace_last_n (T (&dst)[ARRAY_SIZE], const U &needle,
                    const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<std::remove_cv_t<T>>::npos,
                    const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
size_t
str_replace_last_n (T dst, const U &needle, const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<get_char_type_t<T>>::npos,
                    const bool ignore_case_when_searching_for_needle = false,
                    size_t *required_dst_capacity = nullptr)
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
std::basic_string<get_char_type_t<T>>
str_replace_last_n (const T &dst, const U &needle,
                    const size_t last_n_needle_count,
                    size_t start_position_in_dst
                    = std::basic_string<get_char_type_t<T>>::npos,
                    const bool ignore_case_when_searching_for_needle = false,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              && (std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>)>>
size_t
strstr (const T &src, const U &needle)
{
  ...
  if (std::has_facet<std::ctype<char_type>> (loc))
    {
      ...
      std::transform (needle_sv.cbegin (), needle_sv.cend (),
                      std::begin (needle_lc),
                      [&f] (const auto ch) { return f.tolower (ch); });
    }
  else
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
std::basic_string<get_char_type_t<T>>
to_lower_case (const T &src, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
void
to_lower_case_in_place (T &src, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
std::basic_string<get_char_type_t<T>>
to_upper_case (const T &src, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename T,
          typename = std::enable_if_t<is_non_const_char_array_type_v<T>
                                      ...
                                      || is_valid_string_type_v<T>>>
void
to_upper_case_in_place (T &src, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
std::basic_string<get_char_type_t<T>>
to_title_case (const T &src, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename T, typename = std::enable_if_t<
                          ...
                          || is_valid_string_type_v<T>>>
void
to_title_case_in_place (T &src, const std::locale &loc = std::locale{})
{
  using char_type = get_char_type_t<T>;
...
template <typename T>
std::string
num_to_str (const T &data, const char *format_string = nullptr)
{
...
template <typename T>
std::wstring
num_to_wstr (const T &data, const wchar_t *format_string = nullptr)
{
  using data_type = remove_all_decorations_t<T>;
  ...
  while (number)
    {
      ...
      char16_t character_to_use{ static_cast<char16_t> (
          u'0' + character_code_offset) };
...
template <typename T,
          typename
          = std::enable_if_t<std::is_floating_point_v<remove_cv_ref_t<T>>>>
std::u16string
to_u16string (T number, const wchar_t *format_str = nullptr,
  ...
  if (nullptr != format_str)
  ...
  else
    {
      ...
      number_of_decimal_digits
          = min_element (number_of_decimal_digits,
  ...
  while (number)
    {
      ...
      char32_t character_to_use{ static_cast<char32_t> (
          U'0' + character_code_offset) };
...
template <typename T,
          ...
          = std::enable_if_t<std::is_floating_point_v<remove_cv_ref_t<T>>>>
std::u32string
to_u32string (T number, const wchar_t *format_str = nullptr,
              int number_of_decimal_digits
              = std::numeric_limits<remove_cv_ref_t<T>>::digits10)
{
  using floating_type = remove_cv_ref_t<T>;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
int
stoi (const T &src, const number_base base = number_base::decimal,
      bool ignore_leading_white_space_characters = true, size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
        ...
        case number_base::binary:
          if (static_cast<char_type> ('0') == ch
              || static_cast<char_type> ('1') == ch)
            {
              number_value *= 2;
              number_value
                  += static_cast<int> (ch - static_cast<char_type> ('0'));
            }
          else
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
long
stol (const T &src, const number_base base = number_base::decimal,
      bool ignore_leading_white_space_characters = true, size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
        ...
        case number_base::binary:
          if (static_cast<char_type> ('0') == ch
              || static_cast<char_type> ('1') == ch)
            {
              number_value *= 2;
              number_value
                  += static_cast<long> (ch - static_cast<char_type> ('0'));
            }
          else
            found_invalid_character = true;
          break;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
unsigned long
stoul (const T &src, const number_base base = number_base::decimal,
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
long long
stoll (const T &src, const number_base base = number_base::decimal,
       bool ignore_leading_white_space_characters = true,
       size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
      ...
      switch (base)
        ...
        case number_base::binary:
          if (static_cast<char_type> ('0') == ch
            ...
            {
              number_value *= 2;
              number_value += static_cast<long long> (
                  ch - static_cast<char_type> ('0'));
            }
          else
            found_invalid_character = true;
...
template <typename T, typename U,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
unsigned long long
stoull (const T &src, const number_base base = number_base::decimal,
        bool ignore_leading_white_space_characters = true,
        size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
float
stof (const T &src, const number_base base = number_base::decimal,
      bool ignore_leading_white_space_characters = true, size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
  ...
  if (number_base::binary == base
    ...
    ++itr;
           ...
           && 0
                  == str_compare_n_i (itr, std::cend (src_sv),
                                      std::cbegin (binary_number_base_prefix),
                                      std::cend (binary_number_base_prefix),
                                      2))
    itr += 2;

  else if (number_base::octal == base
           && (static_cast<char_type> ('0') == *itr
              ...
              if (exponential_sign_found)
                {
                  ...
                  if (std::abs (exponential_part_value) != 0)
                    number_value *= static_cast<float> (
                        std::pow (2, exponential_part_value));
                }
            }
              ...
              if (exponential_sign_found)
                {
                  ...
                  if (std::abs (exponential_part_value) != 0)
                    number_value *= static_cast<float> (
                        std::pow (8, exponential_part_value));
                }
            }
                      ...
                      if (src_sv[i] >= static_cast<char_type> ('0')
                        ...
                        number_value
                            += src_sv[i] - static_cast<char_type> ('0');
                               ...
                               && src_sv[i] <= static_cast<char_type> ('F'))
                        number_value
                            += 10 + (src_sv[i] - static_cast<char_type> ('A'));
                      else
                        number_value
                            += 10 + (src_sv[i] - static_cast<char_type> ('a'));
                    }
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
double
stod (const T &src, const number_base base = number_base::decimal,
      bool ignore_leading_white_space_characters = true, size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
...
template <typename T,
          typename = std::enable_if_t<
              ...
              || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
long double
stold (const T &src, const number_base base = number_base::decimal,
       bool ignore_leading_white_space_characters = true,
       size_t *pos = nullptr)
{
  using char_type = get_char_type_t<T>;
...
str_find_first_needle_position (
...
template <
    typename T, typename U, typename V = const get_char_type_t<U> *,
    typename = std::enable_if_t<
        (is_valid_string_type_v<T> || is_valid_string_view_type_v<T>
         || is_char_array_type_v<T> || is_char_pointer_type_v<T>)
        && (is_valid_string_type_v<U> || is_valid_string_view_type_v<U>
            || is_char_array_type_v<U> || is_char_pointer_type_v<U>
            || is_valid_char_type_v<U>)
        && (is_valid_string_type_v<V> || is_valid_string_view_type_v<V>
            || is_char_array_type_v<V> || is_char_pointer_type_v<V>
            || is_valid_char_type_v<V> || std::is_same_v<V, std::nullptr_t>)
        && ((std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>
             && std::is_same_v<V, std::nullptr_t>)
            || is_all_of_v<get_char_type_t<T>, get_char_type_t<U>,
                           get_char_type_t<V>>)>>
std::vector<std::basic_string<get_char_type_t<T>>>
str_split (const T &src, const U &needle,
           const V &needle_parts_separator_token = nullptr,
           const split_on_whole_needle_t split_on_whole_needle
           = split_on_whole_needle_t::yes,
           const ignore_empty_string_t ignore_empty_string
           ...
           = std::basic_string<get_char_type_t<T>>::npos)
{
  ...
  const size_t needle_parts_separator_token_len{ len (
      needle_parts_separator_token) };
      ...
      if (needle_parts_separator_token_len > 0U)
        {
          if constexpr (is_char_pointer_type_v<V> || is_char_array_type_v<V>)
            {
              needle_parts_separator_token_sv
                  = { needle_parts_separator_token,
            ...
            {
              needle_parts_separator_token_buffer[0]
                  = needle_parts_separator_token;
              needle_parts_separator_token_buffer[1]
                  = static_cast<char_type> (0);
              needle_parts_separator_token_sv
                  = { needle_parts_separator_token_buffer, 1U };
            }
          else
            {
      ...
      if (needle_parts_separator_token_len > 0U)
        {
          ...
          while (true)
            {
              const size_t next_pos{ needle_sv.find (
                  needle_parts_separator_token_sv, start_pos) };
...
template <typename IteratorType, typename NeedleType,
...
str_split_range (IteratorType first, IteratorType last,
...
template <typename SrcIterType, typename DstIterType>
std::vector<std::pair<SrcIterType, SrcIterType>>
split (const SrcIterType src_first, const SrcIterType src_last,
       const DstIterType needle_first, const DstIterType needle_last,
       const split_on_whole_sequence_t split_on_whole_sequence
       = split_on_whole_sequence_t::yes,
       const ignore_empty_sequence_t ignore_empty_sequence
       = ignore_empty_sequence_t::yes,
       const size_t max_count = std::string::npos)
{
  const typename std::iterator_traits<SrcIterType>::difference_type
  ...
  if (needle_first == needle_last)
    {
      ...
      const size_t upper_limit{ max_count < source_len ? max_count
                                                       : source_len };
      parts.reserve (upper_limit);
  ...
  const size_t needle_sequence_len{ split_on_whole_sequence
                                            == split_on_whole_sequence_t::yes
                                        ? static_cast<size_t> (needle_distance)
                                        : 1U };
  ...
  while (prev != src_last)
    {
      ...
      if ((std::distance (prev, next) > 0
           || ignore_empty_sequence == ignore_empty_sequence_t::no)
  ...
  if ((std::distance (prev, src_last) > 0
       || ignore_empty_sequence == ignore_empty_sequence_t::no)
      && (number_of_parts < max_count))
...
template <typename T, typename U, typename... Args,
          typename = std::enable_if_t<
              ...
              || is_valid_string_view_type_v<T>>>
std::basic_string<get_char_type_t<T>>
join_helper (const T &needle, U &&arg, Args &&...args)
{
  using char_type = get_char_type_t<T>;
  std::basic_ostringstream<char_type> oss{};
...
template <typename T, typename... Args,
          typename = std::enable_if_t<
              ...
              || is_valid_string_view_type_v<T>>>
std::basic_string<get_char_type_t<T>>
join (const T &needle, Args &&...args)
{
  using char_type = get_char_type_t<T>;
  std::basic_string<char_type> result{ join_helper (
      needle, std::forward<Args> (args)...) };
  return result;
}

template <
    typename ContainerType, typename NeedleType,
    typename = std::enable_if_t<
        (is_valid_char_type_v<NeedleType> || is_char_pointer_type_v<NeedleType>
         || is_char_array_type_v<NeedleType>
...
str_join (const ContainerType &items, const NeedleType &needle)
{
...
template <
    typename FwIterType, typename NeedleType,
    typename = std::enable_if_t<
        (is_valid_char_type_v<NeedleType> || is_char_pointer_type_v<NeedleType>
         || is_char_array_type_v<NeedleType>
         || is_valid_string_type_v<NeedleType>
        ...
        && has_output_stream_operator_v<
            std::basic_ostream<get_char_type_t<NeedleType>>,
            typename std::iterator_traits<FwIterType>::value_type>>>
std::basic_string<get_char_type_t<NeedleType>>
...
template <typename ForwardIterType1, typename ForwardIterType2,
          typename Predicate>
constexpr std::pair<ForwardIterType1, ForwardIterType2>
copy_forward_while_true (ForwardIterType1 src_first,
                         const ForwardIterType1 src_last,
                         ForwardIterType2 dst_first, Predicate p)
{
...
copy_backward_while_true (const BidirIterType1 src_first,
                          BidirIterType1 src_last, BidirIterType2 dst_last,
                          Predicate p)
{
...
template <typename BidirIterType1, typename BidirIterType2, typename Predicate>
constexpr std::pair<BidirIterType1, BidirIterType2>
copy_backward_while_false (const BidirIterType1 src_first,
                           BidirIterType1 src_last, BidirIterType2 dst_last,
                           Predicate p)
{
  while (src_first != src_last)
...
template <typename ForwardIterType1, typename ForwardIterType2,
          typename Predicate>
constexpr std::pair<ForwardIterType1, ForwardIterType2>
move_forward_while_true (
    ForwardIterType1 src_first, const ForwardIterType1 src_last,
...
template <typename BidirIterType1, typename BidirIterType2, typename Predicate>
constexpr std::pair<BidirIterType1, BidirIterType2>
move_backward_while_true (
    const BidirIterType1 src_first, BidirIterType1 src_last,
...
BidirIterType
stable_partition (BidirIterType first, BidirIterType last, UnaryPredicate p)
{
...
std::pair<BidirIterType, BidirIterType>
stable_gather (BidirIterType first, BidirIterType last,
               const BidirIterType target, BinaryPredicate p)
{
  BidirIterType tmp_last{ last };
...
constexpr const T *
find_first (const T (&arr)[N], const X &x)
{
...
constexpr const T *
find_first_if (const T (&arr)[N], Pred p)
{
...
template <typename T, size_t N, typename X>
constexpr const T *
find_last (const T (&arr)[N], const X &x)
{
...
template <typename T, size_t N, typename Pred>
constexpr const T *
find_last_if (const T (&arr)[N], Pred p)
{
...
template <typename T, size_t N, typename X>
constexpr std::vector<const T *>
find_all (const T (&arr)[N], const X &x)
{
...
template <typename T, size_t N, typename Pred>
constexpr std::vector<const T *>
find_all_if (const T (&arr)[N], Pred p)
{
...
find_first (const std::array<T, N> &arr, const X &x)
{
  return detail::find_first_impl (
...
template <typename T, size_t N, typename Pred>
constexpr typename std::array<T, N>::const_iterator
find_first_if (const std::array<T, N> &arr, Pred p)
{
  return detail::find_first_if_impl (
...
template <typename T, size_t N, typename X>
constexpr typename std::array<T, N>::const_iterator
find_last (const std::array<T, N> &arr, const X &x)
{
  return detail::find_last_impl (
      arr, x, typename detail::container_traits<std::array<T, N>>::category{});
}
...
template <typename T, size_t N, typename Pred>
constexpr typename std::array<T, N>::const_iterator
find_last_if (const std::array<T, N> &arr, Pred p)
{
  return detail::find_last_if_impl (
      arr, p, typename detail::container_traits<std::array<T, N>>::category{});
}
...
template <typename T, size_t N, typename X>
constexpr std::vector<typename std::array<T, N>::const_iterator>
find_all (const std::array<T, N> &arr, const X &x)
{
  return detail::find_all_impl (
      arr, x, typename detail::container_traits<std::array<T, N>>::category{});
}
...
template <typename T, size_t N, typename Pred>
constexpr std::vector<typename std::array<T, N>::const_iterator>
find_all_if (const std::array<T, N> &arr, Pred p)
{
  return detail::find_all_if_impl (
      arr, p, typename detail::container_traits<std::array<T, N>>::category{});
}
...
find_first (const Container &c, const X &x)
{
  return detail::find_first_impl (
...
constexpr typename Container::const_iterator
find_first_if (const Container &c, Pred p)
{
  return detail::find_first_if_impl (
...
template <typename Container, typename X>
constexpr typename Container::const_iterator
find_last (const Container &c, const X &x)
{
  return detail::find_last_impl (
      c, x, typename detail::container_traits<Container>::category{});
}
...
template <typename Container, typename Pred>
constexpr typename Container::const_iterator
find_last_if (Container &c, Pred p)
{
  return detail::find_last_if_impl (
      c, p, typename detail::container_traits<Container>::category{});
}
...
template <typename Container, typename X>
constexpr std::vector<typename Container::const_iterator>
find_all (Container &c, const X &x)
{
  return detail::find_all_impl (
      c, x, typename detail::container_traits<Container>::category{});
}
...
template <typename Container, typename Pred>
constexpr std::vector<typename Container::const_iterator>
find_all_if (Container &c, Pred p)
{
  return detail::find_all_if_impl (
      c, p, typename detail::container_traits<Container>::category{});
}
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert (Container &c, const X &x)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_beginning (Container &c, const X &x)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_end (Container &c, const X &x)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_first (Container &c, const X &x)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_last (Container &c, const X &x)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_all (Container &c, const X &x)
{
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_first_if (Container &c, Pred p)
{
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_last_if (Container &c, Pred p)
{
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_all_if (Container &c, Pred p)
{
