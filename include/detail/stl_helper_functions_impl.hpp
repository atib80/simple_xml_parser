...
template <typename T, typename... T0_TN> struct is_all_of_impl;

template <typename T> struct is_all_of_impl<T> : std::true_type
{
};
...
template <typename T, typename... T0_TN> struct is_anyone_of_impl;

template <typename T> struct is_anyone_of_impl<T> : std::false_type
{
};
...
template <typename T> struct is_valid_char_type
{
  static constexpr const bool value
      = is_anyone_of_impl<std::remove_cv_t<T>, std::nullptr_t, char, wchar_t,
                          char16_t, char32_t
...
template <typename T,
          typename = std::enable_if_t<is_valid_char_type<T>::value>>
std::vector<size_t>
str_find_all_of_impl (std::basic_string_view<T> src_sv,
...
template <typename T, size_t N> struct container_traits<T[N]>
{
...
erase_first_impl (T (&arr)[N], const X &x, array_like_container_tag)
{
...
template <typename T, size_t N, typename X>
CPP20_USE_CONSTEXPR bool
erase_last_impl (T (&arr)[N], const X &x, array_like_container_tag)
{
  auto iter = arr + N;
  while (iter != arr)
    {
...
template <typename T, size_t N, typename X>
CPP20_USE_CONSTEXPR bool
erase_all_impl (T (&arr)[N], const X &x, array_like_container_tag)
{
...
CPP20_USE_CONSTEXPR bool
erase_first_if_impl (T (&arr)[N], Pred p, array_like_container_tag)
{
...
template <typename T, size_t N, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_last_if_impl (T (&arr)[N], Pred p, array_like_container_tag)
{
  auto iter = arr + N;
  while (iter != arr)
    {
...
template <typename T, size_t N, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_all_if_impl (T (&arr)[N], Pred p, array_like_container_tag)
{
...
template <typename T, size_t N, typename X>
CPP20_USE_CONSTEXPR bool
erase_first_impl (std::array<T, N> &c, const X &x, array_like_container_tag)
{
...
template <typename T, size_t N, typename X>
CPP20_USE_CONSTEXPR bool
erase_last_impl (std::array<T, N> &c, const X &x, array_like_container_tag)
{
...
template <typename T, size_t N, typename X>
CPP20_USE_CONSTEXPR bool
erase_all_impl (std::array<T, N> &c, const X &x, array_like_container_tag)
{
...
template <typename T, size_t N, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_first_if_impl (std::array<T, N> &c, Pred p, array_like_container_tag)
{
...
template <typename T, size_t N, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_last_if_impl (std::array<T, N> &c, Pred p, array_like_container_tag)
{
...
template <typename T, size_t N, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_all_if_impl (std::array<T, N> &c, Pred p, array_like_container_tag)
{
...
CPP20_USE_CONSTEXPR bool
erase_first_impl (Container &c, const X &x, vector_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_last_impl (Container &c, const X &x, vector_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_all_impl (Container &c, const X &x, vector_like_container_tag)
{
...
CPP20_USE_CONSTEXPR bool
erase_first_if_impl (Container &c, Pred p, vector_like_container_tag)
{
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_last_if_impl (Container &c, Pred p, vector_like_container_tag)
{
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_all_if_impl (Container &c, Pred p, vector_like_container_tag)
{
  const size_t original_size = c.size ();
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_first_impl (Container &c, const X &x, list_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_last_impl (Container &c, const X &x, list_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_all_impl (Container &c, const X &x, list_like_container_tag)
{
  const size_t original_size = c.size ();
  c.remove (x);
  return c.size () < original_size;
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_first_if_impl (Container &c, Pred p, list_like_container_tag)
{
  for (auto iter = c.cbegin (); iter != c.cend (); ++iter)
    {
      if (p (*iter))
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_last_if_impl (Container &c, Pred p, list_like_container_tag)
{
  if constexpr (std::is_same_v<
                    typename std::iterator_traits<
                        typename Container::const_iterator>::iterator_category,
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_all_if_impl (Container &c, Pred p, list_like_container_tag)
{
  const size_t original_size = c.size ();
  c.remove_if (p);
  return c.size () < original_size;
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_first_impl (Container &c, const X &x, associative_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_last_impl (Container &c, const X &x, associative_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR bool
erase_all_impl (Container &c, const X &x, associative_like_container_tag)
{
  const size_t original_size = c.size ();
  c.erase (x);
  return c.size () < original_size;
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_first_if_impl (Container &c, Pred p, associative_like_container_tag)
{
  for (auto iter = c.cbegin (); iter != c.cend (); ++iter)
    {
      if (p (*iter))
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_last_if_impl (Container &c, Pred p, associative_like_container_tag)
{
  if constexpr (std::is_same_v<
                    typename std::iterator_traits<
                        typename Container::const_iterator>::iterator_category,
...
template <typename Container, typename Pred>
CPP20_USE_CONSTEXPR bool
erase_all_if_impl (Container &c, Pred p, associative_like_container_tag)
{
  const size_t original_size = c.size ();
...
template <typename T, size_t N, typename X>
constexpr const T *
find_first_impl (const T (&arr)[N], const X &x, array_like_container_tag)
{
  auto iter = &arr[0];
...
template <typename T, size_t N, typename Pred>
constexpr const T *
find_first_if_impl (const T (&arr)[N], Pred p, array_like_container_tag)
{
  auto iter = &arr[0];
...
template <typename T, size_t N, typename X>
constexpr const T *
find_last_impl (const T (&arr)[N], const X &x, array_like_container_tag)
{
...
template <typename T, size_t N, typename Pred>
constexpr const T *
find_last_if_impl (const T (&arr)[N], Pred p, array_like_container_tag)
{
  for (auto iter = arr + N; iter != arr;)
    {
      if (p (*--iter))
...
find_first_impl (const std::array<T, N> &c, const X &x,
...
template <typename T, size_t N, typename Pred>
constexpr typename std::array<T, N>::const_iterator
find_first_if_impl (const std::array<T, N> &c, Pred p,
                    array_like_container_tag)
{
  auto iter = c.cbegin ();
...
template <typename T, size_t N, typename X>
constexpr typename std::array<T, N>::const_iterator
find_last_impl (const std::array<T, N> &c, const X &x,
                array_like_container_tag)
{
  for (auto iter = c.crbegin (); iter != c.crend (); ++iter)
    {
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR typename Container::const_iterator
find_first_impl (const Container &c, const X &x,
...
insert_impl (Container &c, IterType iter, const X &x,
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_beginning_impl (Container &c, const X &x, vector_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_end_impl (Container &c, const X &x, vector_like_container_tag)
{
...
template <typename Container, typename IterType, typename X>
CPP20_USE_CONSTEXPR auto
insert_impl (Container &c, IterType iter, const X &x, list_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_beginning_impl (Container &c, const X &x, list_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_end_impl (Container &c, const X &x, list_like_container_tag)
{
  if constexpr (std::is_same_v<
                    typename std::iterator_traits<
                        typename Container::const_iterator>::iterator_category,
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_impl (Container &c, const X &x, associative_like_container_tag)
{
  return c.insert (x);
}
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_beginning_impl (Container &c, const X &x,
                          associative_like_container_tag)
{
...
template <typename Container, typename X>
CPP20_USE_CONSTEXPR auto
insert_at_end_impl (Container &c, const X &x, associative_like_container_tag)
{
